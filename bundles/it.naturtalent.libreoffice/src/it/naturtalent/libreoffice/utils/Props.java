  ...
  */
  {
	...
	/*
	 * print out the properties as name = value pairs, one per line. If the
	 * value is a string array or a PropertyValue array, then cycle through the
	 * values in the array.
	 */
	{
